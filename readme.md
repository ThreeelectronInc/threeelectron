...
A minimal template to get going quickly with Three.js, React and Electron for 3D desktop applications.  A few additional libraries such as Tone.JS are included for demo purposes only.  The core dependencies included are Three.js, React and Electron.
